...
const options = {
  definition: {
    ...
    info: {
      ...
      description: 'Order Service microservice API for the Coconut Production System. This service handles selling coconut related products and managing customer orders.',
      version: '1.0.0',
      contact: {
        name: 'Support',
